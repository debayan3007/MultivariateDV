var crossChart = function (RenderGraph, coordinateOb, dataob, width, height, productSeq, maxP, minP, colorRange, colorRangeLoss) {
	...
	for (var i = 0; i < lengthTemp; i++) {
		...
		function a(j) {
			...
			document.addEventListener('onHighlight', function (event) {
				...
				// console.log(_this.dataob[j].sos);
