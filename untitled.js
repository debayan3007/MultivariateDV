                    ...
                    if(tempOb[jI].time == xCoordinate[i][1]) 
                    {
                      ...
                      if(iI == axisName)
                      {
                        ...
                        if(spanToolText[count] == undefined)
                        {
                          ...
                          document.getElementById("svgC"+iI.charAt(5)).removeChild(spanToolText[count]);
                          document.getElementById("svgC"+iI.charAt(5)).removeChild(toolBox[count]);
                          ...
                          //toolBox[count].setAttribute("visibility",hidden);
                          ...
                          //spanToolText[count].setAttribute("visibility",hidden);
                          ...
                          //   toolBox[count].setAttribute("visibility",visible);
                          //   spanToolText[count].setAttribute("visibility",visible);
                          // }, 3000);
